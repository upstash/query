...
describe('documentKey', () => {
    ...
    const testCases: { documentId: string, want: string }[] = [
        ...
        { documentId: 'document:id/with.special_chars', want: `@upstash/query:collection:${name}:document:id/with.special_chars` },
...
describe('list', () => {
    ...
    test("should not return null elements", async () => {
        ...
        const documentIds = new Array(10).map(() => crypto.randomUUID())
